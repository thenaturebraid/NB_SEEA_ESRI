'''
Preprocessing tool for NB. Generates hydrographical and topographical files
for use in other NB functions.
'''
import arcpy
...
import NB_SEEA_ESRI.solo.reconditionDEM as reconditionDEM
import NB_SEEA_ESRI.lib.baseline as baseline
